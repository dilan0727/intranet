                  ...
                  <div>
                    <div class="view view-procedimientos-y-formatos view-id-procedimientos_y_formatos view-display-id-page view-dom-id-2ed9efb3afdc498a8485994c28f5e0a8">
                      <div class="view-content">
                        ...
                        <br>
                        <div class="titulop" style="width: 100%;">Procesos de Apoyo
                        </div>
                        <table style="width: 100%">
                          <tbody>
                            <tr>
                              <td style="width: 100%">
                                <div class="titulopf">Gestión Administrativa y Financiera
          <table style="width: 100%">
            <tbody>
            <?php 
                ...
                <b>Fecha Aprobación:
                  ...
                  <span class="file">
                    ...
                    <a href="visualizacion.php?id=<?php echo $id?>" src="../imagenes/pdf.png"  ><?php echo $tipo;?></a>
