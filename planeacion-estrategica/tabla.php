                  ...
                  <div>
                    <div class="view view-procedimientos-y-formatos view-id-procedimientos_y_formatos view-display-id-page view-dom-id-2ed9efb3afdc498a8485994c28f5e0a8">
                      <div class="view-content">
                        <a href="planeacion-estrategica.php" title="Volver">
              ...
              <tr>
                ...
                <td class="titulonom">
                  ...
                  <?php if ($tipoarchivo == "caracterizacion" || $tipoarchivo == "anexo"|| $tipoarchivo == "procedimiento"|| $tipoarchivo == "normograma"|| $tipoarchivo == "requisito"|| $tipoarchivo == "instructivo"): ?>
                             <a href="subvisualizacion.php?id=<?php echo $id; ?>&idd=<?php echo $idd?>" src="../imagenes/pdf.png"><?php echo $titulo; ?></a>
                       <?php else: ?>
                        <a href="cargar.php?id=<?php echo $id; ?>" target="_blank"><?php echo $titulo; ?></a>
<?php endif; ?>
                  </span>
                  <table style="width: 100%">
                  </table>
                  ...
                  <td ><a class='btn33 btn-danger' href="subeditar.php?id=<?php echo $id?>&idd=<?php echo $idd?>">Editar</a> </td>
                  </tr>
